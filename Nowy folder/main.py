...
text_select_function: str = "Wybierz funkcję (1.Wielomian, 2.Trygonometryczna, 3.Wykładnicza, 4.Modulo, 5.Złożona): "


def main():
    print("Program oblicza interpolacje przy pomocy metody Lagrange'a dla nierównych odstępów argumentu")
    wybor = int(input("Wybierz czy program ma wziać wartosći (1.z pliku, 2.po przez funkcje)"))
    tabx = []
    taby = []
    function: object
    match wybor:
